...
function RentCarDetails (){
  ...
  useEffect(()=>{
    ...
    .then((res)=>
    {
      ...
      setpickup_place(singleCarItem.pickup_place)
      setfirst_date_availability(singleCarItem.first_date_availability)
      setsecond_date_availability(singleCarItem.second_date_availability)
      ...
      setImage2(singleCarItem.image1)
      setImage3(singleCarItem.image1)
      setImage4(singleCarItem.image1)
          ...
          <Row>
              ...
              <div className=" d-flex align-items-center gap-5 mb-4 mt-3">
                <h2 className="section__title">{carName}</h2>
                  ...
                  <span className=" d-flex align-items-center gap-2">
                    ...
                    Available From : <span style={{ color: "#f9a826" }}>{first_date_availability.substring(0, 10)}<br></br></span>
                    To             : <span style={{ color: "#f9a826" }}>{second_date_availability.substring(0, 10)}<br></br></span>
                    </h5>
                  </span>
                </div>
                ...
                <p className="section__description">
                  ...
                  PickUp Place : {pickup_place}<br></br>
                </p>
            ...
            <Col lg="7" className="mt-5">
              <div className="booking-info mt-5">
                <h5 className="mb-4 fw-bold ">Send Inquiry</h5>
